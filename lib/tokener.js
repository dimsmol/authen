...
var Tokener = function (signer, opt_options, opt_identityEqualsFunc, opt_getLastRevocationTimeFunc) {
	...
	this.options.cookies.nameLower = this.options.cookies.name.toLowerCase();
};
...
Tokener.prototype.getAuthData = function (req) {
	...
	if (token == null && !this.options.cookies.useLimited && req.cookies != null) {
		token = req.cookies[this.options.cookies.nameLower];
	...
	if (token != null) {
		...
		if (!tokenFromCookie && req.cookies != null) {
			result.additionalToken = req.cookies[this.options.cookies.nameLower];
		}
	}
	return result;
};
